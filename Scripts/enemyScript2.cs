...
public class enemyScript2 : MonoBehaviour
{
    ...
    //Body Components
    public RuntimeAnimatorController opponent;
    Rigidbody2D rb;
    ...
    void Update()
    {
        ...
        if(CanSeePlayer(attackDistance) && !animator.GetBool("isGuarding"))
        {
        ...
        else if(CanSeePlayer(agroRange) && HealthPoints >= 1 && !animator.GetBool("isGuarding"))
        {
            ChasePlayer();
        }
    ...
    public void destroy()
    {
        ...
        else if (dropRate > 35 && dropRate < 50)
        {
            //Spawn damage up
